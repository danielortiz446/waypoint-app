...
const server=http.createServer(async(req,res)=>{
  ...
  try{
    ...
    if(req.method==='GET'&&u.pathname==='/health') return json(res,200,{ok:true,service:'waypoint',version:'10.0.4',time:new Date().toISOString()});
...
server.listen(PORT,HOST,()=>console.log(`Waypoint 10.0.4 listening on http://${HOST}:${PORT}`));
